...
public class OverseerPillarEntity extends PathfinderMob {
	public OverseerPillarEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheDeepVoidModEntities.OVERSEER_PILLAR.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(TheDeepVoidModEntities.OVERSEER_PILLAR.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
