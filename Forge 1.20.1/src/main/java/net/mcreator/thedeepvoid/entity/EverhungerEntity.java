...
public class EverhungerEntity extends Monster implements GeoEntity {
	...
	public EverhungerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheDeepVoidModEntities.EVERHUNGER.get(), world);
	}
	...
	public SoundEvent getDeathSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("the_deep_void:everhunger_chase"));
	}
	...
	public static void init() {
		SpawnPlacements.register(TheDeepVoidModEntities.EVERHUNGER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
