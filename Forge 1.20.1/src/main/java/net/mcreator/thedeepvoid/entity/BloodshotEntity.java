...
import net.mcreator.thedeepvoid.procedures.BloodshotWhileProjectileFlyingTickProcedure;
...
public class BloodshotEntity extends AbstractArrow implements ItemSupplier {
	...
	public BloodshotEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(TheDeepVoidModEntities.BLOODSHOT.get(), world);
	}
	...
	public void tick() {
		super.tick();
		BloodshotWhileProjectileFlyingTickProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
		if (this.inGround)
			this.discard();
	}
	...
	public static BloodshotEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
	...
	public static BloodshotEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		BloodshotEntity entityarrow = new BloodshotEntity(TheDeepVoidModEntities.BLOODSHOT.get(), entity, world);
	...
	public static BloodshotEntity shoot(LivingEntity entity, LivingEntity target) {
		BloodshotEntity entityarrow = new BloodshotEntity(TheDeepVoidModEntities.BLOODSHOT.get(), entity, entity.level());
