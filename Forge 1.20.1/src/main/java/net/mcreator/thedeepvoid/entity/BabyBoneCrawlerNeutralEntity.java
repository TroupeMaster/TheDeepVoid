...
import net.mcreator.thedeepvoid.procedures.BabyBoneCrawlerNeutralTickProcedure;
import net.mcreator.thedeepvoid.procedures.BabyBoneCrawlerNeutralRightClickedOnEntityProcedure;
import net.mcreator.thedeepvoid.init.TheDeepVoidModEntities;

public class BabyBoneCrawlerNeutralEntity extends Monster implements GeoEntity {
	...
	public BabyBoneCrawlerNeutralEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheDeepVoidModEntities.BABY_BONE_CRAWLER_NEUTRAL.get(), world);
	}

	public BabyBoneCrawlerNeutralEntity(EntityType<BabyBoneCrawlerNeutralEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		BabyBoneCrawlerNeutralRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		BabyBoneCrawlerNeutralTickProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BabyBoneCrawlerNeutralEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
