...
public class Modelbone_crawler<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "bone_crawler"), "main");
	private final ModelPart body;
	private final ModelPart head;
	private final ModelPart leg_left_last;
	private final ModelPart leg_left_middle;
	private final ModelPart leg_left_front;
	private final ModelPart leg_right_last;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(23, 21).addBox(
				-4.0F, -1.0F, -3.0F, 8.0F, 2.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 23.0F, 0.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(34, 0).addBox(
				-4.0F, -1.0F, -5.0F, 8.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 23.0F, -3.0F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 34).addBox(-8.0F, -8.0F, 0.0F, 16.0F, 8.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.0F, -5.0F, 0.8727F, 0.0F, 0.0F));

		PartDefinition leg_left_last = partdefinition
				.addOrReplaceChild("leg_left_last",
						CubeListBuilder.create().texOffs(12, 28).addBox(0.0F, 0.0F, -2.0F, 9.0F, 0.0F, 4.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(4.0F, 23.0F, 6.0F, 0.0F, 0.0F, 0.0873F));

		PartDefinition leg_left_middle = partdefinition
				.addOrReplaceChild("leg_left_middle",
						CubeListBuilder.create().texOffs(12, 28).addBox(0.0F, 0.0F, -2.0F, 9.0F, 0.0F, 4.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(4.0F, 23.0F, 2.0F, 0.0F, 0.0F, 0.0873F));

		PartDefinition leg_left_front = partdefinition.addOrReplaceChild("leg_left_front",
				CubeListBuilder.create().texOffs(12, 28).addBox(0.0F, 0.0F, -2.0F, 9.0F, 0.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0F, 23.0F, -2.0F, 0.0F, 0.0F, 0.0873F));

		PartDefinition leg_right_last = partdefinition.addOrReplaceChild("leg_right_last",
				CubeListBuilder.create().texOffs(12, 12).addBox(-9.0F, 0.0F, -2.0F, 9.0F, 0.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.0F, 23.0F, 6.0F, 0.0F, 0.0F, -0.0873F));

		PartDefinition leg_right_middle = partdefinition.addOrReplaceChild("leg_right_middle",
				CubeListBuilder.create().texOffs(12, 12).addBox(-9.0F, 0.0F, -2.0F, 9.0F, 0.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.0F, 23.0F, 2.0F, 0.0F, 0.0F, -0.0873F));

		PartDefinition leg_right_front = partdefinition.addOrReplaceChild("leg_right_front",
				CubeListBuilder.create().texOffs(12, 12).addBox(-9.0F, 0.0F, -2.0F, 9.0F, 0.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.0F, 23.0F, -2.0F, 0.0F, 0.0F, -0.0873F));
