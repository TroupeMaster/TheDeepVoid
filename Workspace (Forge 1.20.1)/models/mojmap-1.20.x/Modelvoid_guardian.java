...
public class Modelvoid_guardian<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "void_guardian"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rods = partdefinition.addOrReplaceChild("rods",
				CubeListBuilder.create().texOffs(0, 50)
						.addBox(-1.0F, -6.0F, -8.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(56, 50)
						.addBox(-1.0F, -6.0F, 6.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)),
