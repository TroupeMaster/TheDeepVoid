...
import net.mcreator.thedeepvoid.procedures.VoodooDollSpecialInformationProcedure;
...
public class VoodooDollItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal(VoodooDollSpecialInformationProcedure.execute()));
	}
