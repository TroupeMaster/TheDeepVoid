...
public class PrimordialCrawlerEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(PrimordialCrawlerEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(PrimordialCrawlerEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(PrimordialCrawlerEntity.class, EntityDataSerializers.STRING);
	...
	public PrimordialCrawlerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheDeepVoidModEntities.PRIMORDIAL_CRAWLER.get(), world);
	}

	public PrimordialCrawlerEntity(EntityType<PrimordialCrawlerEntity> type, Level world) {
		super(type, world);
		xpReward = 250;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new LookAtPlayerGoal(this, Player.class, (float) 40));
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 133) {
			this.remove(PrimordialCrawlerEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
