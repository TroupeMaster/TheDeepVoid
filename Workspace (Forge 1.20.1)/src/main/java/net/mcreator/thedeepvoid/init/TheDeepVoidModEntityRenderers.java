...
import net.mcreator.thedeepvoid.client.renderer.PrimordialCrawlerRenderer;
...
public class TheDeepVoidModEntityRenderers {
	...
	public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(TheDeepVoidModEntities.PRIMORDIAL_CRAWLER.get(), PrimordialCrawlerRenderer::new);
