...
import net.mcreator.thedeepvoid.item.model.SoulWingsModel;
import net.mcreator.thedeepvoid.item.SoulWingsItem;

public class SoulWingsArmorRenderer extends GeoArmorRenderer<SoulWingsItem> {
	public SoulWingsArmorRenderer() {
		super(new SoulWingsModel());
	...
	@Override
	public RenderType getRenderType(SoulWingsItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
