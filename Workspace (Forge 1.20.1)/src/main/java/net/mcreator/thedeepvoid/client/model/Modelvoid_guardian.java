...
public class Modelvoid_guardian<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("the_deep_void", "modelvoid_guardian"), "main");
	...
	public Modelvoid_guardian(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rods = partdefinition.addOrReplaceChild("rods",
				CubeListBuilder.create().texOffs(0, 50).addBox(-1.0F, -6.0F, -8.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(56, 50).addBox(-1.0F, -6.0F, 6.0F, 2.0F, 12.0F, 2.0F, new CubeDeformation(0.0F)),
