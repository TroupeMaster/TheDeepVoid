	...
	private static void execute(@Nullable Event event, Entity entity, ItemStack itemstack, List<Component> tooltip) {
		...
		if (itemstack.getItem() == TheDeepVoidModItems.CRAWLER_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.GRIM_CRAWLER_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.CRAWLER_ROYALTY_CHESTPLATE.get()) {
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.crawler_chestplate.key_press").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.crawler_chestplate.on_key_press").getString())));
			} else {
		...
		if ((itemstack.getItem() == TheDeepVoidModItems.CRAWLER_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.CRAWLER_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.CRAWLER_LEGGINGS.get()
			...
			if (Screen.hasShiftDown()) {
				...
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.crawler.worn1").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.crawler.worn2").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.crawler.worn3").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.crawler.worn4").getString())));
			} else {
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.press_shift").getString())));
			}
		}
		if ((itemstack.getItem() == TheDeepVoidModItems.GRIM_CRAWLER_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.GRIM_CRAWLER_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.GRIM_CRAWLER_LEGGINGS.get()
			...
			if (Screen.hasShiftDown()) {
				...
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.crawler.worn3").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.crawler.worn4").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.grim_crawler.when_darkness").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.grim_crawler.in_darkness1").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.grim_crawler.in_darkness2").getString())));
			} else {
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.press_shift").getString())));
			}
		}
