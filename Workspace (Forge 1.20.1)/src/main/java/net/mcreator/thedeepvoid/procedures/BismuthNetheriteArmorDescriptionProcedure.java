...
public class BismuthNetheriteArmorDescriptionProcedure {
	...
	private static void execute(@Nullable Event event, Entity entity, ItemStack itemstack, List<Component> tooltip) {
		...
		if ((itemstack.getItem() == TheDeepVoidModItems.BISMUTH_NETHERITE_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.BISMUTH_NETHERITE_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.BISMUTH_NETHERITE_LEGGINGS.get()
				...
				&& (entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getItem() == TheDeepVoidModItems.BISMUTH_NETHERITE_HELMET.get()
			...
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.bismuth_netherite.when_worn").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.bismuth_netherite.worn").getString())));
			} else {
