...
import net.mcreator.thedeepvoid.procedures.BoneCageClosedOnInitialEntitySpawnProcedure;
import net.mcreator.thedeepvoid.procedures.BoneCageClosedOnEntityTickUpdateProcedure;
import net.mcreator.thedeepvoid.init.TheDeepVoidModEntities;

import javax.annotation.Nullable;

public class BoneCageClosedEntity extends Monster implements GeoEntity {
	...
	public BoneCageClosedEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheDeepVoidModEntities.BONE_CAGE_CLOSED.get(), world);
	}

	public BoneCageClosedEntity(EntityType<BoneCageClosedEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0f);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		BoneCageClosedOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		BoneCageClosedOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	private PlayState movementPredicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			return event.setAndContinue(RawAnimation.begin().thenLoop("animation.boneCage_close"));
		}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BoneCageClosedEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
