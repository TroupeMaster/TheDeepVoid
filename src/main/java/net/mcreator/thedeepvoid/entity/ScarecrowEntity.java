...
public class ScarecrowEntity extends Monster implements GeoEntity {
	...
	public ScarecrowEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheDeepVoidModEntities.SCARECROW.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(TheDeepVoidModEntities.SCARECROW.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
