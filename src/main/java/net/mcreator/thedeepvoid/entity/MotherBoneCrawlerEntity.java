...
public class MotherBoneCrawlerEntity extends Monster implements GeoEntity {
	...
	public MotherBoneCrawlerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheDeepVoidModEntities.MOTHER_BONE_CRAWLER.get(), world);
	}

	public MotherBoneCrawlerEntity(EntityType<MotherBoneCrawlerEntity> type, Level world) {
		super(type, world);
		xpReward = 15;
		setNoAi(false);
		setMaxUpStep(1f);
	...
	public static void init() {
		SpawnPlacements.register(TheDeepVoidModEntities.MOTHER_BONE_CRAWLER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(MotherBoneCrawlerEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
