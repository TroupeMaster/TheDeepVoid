...
public class SleepingPrimordialCrawlerEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SleepingPrimordialCrawlerEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SleepingPrimordialCrawlerEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(SleepingPrimordialCrawlerEntity.class, EntityDataSerializers.STRING);
	...
	public SleepingPrimordialCrawlerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheDeepVoidModEntities.SLEEPING_PRIMORDIAL_CRAWLER.get(), world);
	}

	public SleepingPrimordialCrawlerEntity(EntityType<SleepingPrimordialCrawlerEntity> type, Level world) {
		super(type, world);
		xpReward = 250;
		setNoAi(false);
		setMaxUpStep(0f);
	...
	public boolean hurt(DamageSource source, float amount) {
		SleepingPrimordialCrawlerEntityIsHurtProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	private PlayState movementPredicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			return event.setAndContinue(RawAnimation.begin().thenLoop("animation.primordialCrawler_sleep"));
		}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 133) {
			this.remove(SleepingPrimordialCrawlerEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
