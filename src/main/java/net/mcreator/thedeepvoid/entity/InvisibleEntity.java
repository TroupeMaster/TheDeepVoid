...
public class InvisibleEntity extends AbstractArrow implements ItemSupplier {
	...
	public InvisibleEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(TheDeepVoidModEntities.INVISIBLE.get(), world);
	}
	...
	public static InvisibleEntity shoot(Level world, LivingEntity entity, RandomSource source) {
		return shoot(world, entity, source, 0f, 0, 0);
	}

	public static InvisibleEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 0f, 0, 0);
	}

	public static InvisibleEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		InvisibleEntity entityarrow = new InvisibleEntity(TheDeepVoidModEntities.INVISIBLE.get(), entity, world);
	...
	public static InvisibleEntity shoot(LivingEntity entity, LivingEntity target) {
		InvisibleEntity entityarrow = new InvisibleEntity(TheDeepVoidModEntities.INVISIBLE.get(), entity, entity.level());
