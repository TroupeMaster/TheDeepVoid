...
public class SeekerModel extends GeoModel<SeekerEntity> {
	...
	public ResourceLocation getAnimationResource(SeekerEntity entity) {
		return new ResourceLocation("the_deep_void", "animations/seeker.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(SeekerEntity entity) {
		return new ResourceLocation("the_deep_void", "geo/seeker.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(SeekerEntity animatable, long instanceId, AnimationState animationState) {
