...
import net.mcreator.thedeepvoid.procedures.ApostleOfCatastropheParryProcedure;
import net.mcreator.thedeepvoid.procedures.ApostleOfCatastropheOnInitialEntitySpawnProcedure;
import net.mcreator.thedeepvoid.procedures.ApostleOfCatastropheOnEntityTickUpdateProcedure;
import net.mcreator.thedeepvoid.procedures.ApostleDiesProcedure;
import net.mcreator.thedeepvoid.init.TheDeepVoidModEntities;

import javax.annotation.Nullable;

public class ApostleOfCatastropheEntity extends Monster implements GeoEntity {
	...
	public ApostleOfCatastropheEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheDeepVoidModEntities.APOSTLE_OF_CATASTROPHE.get(), world);
	}

	public ApostleOfCatastropheEntity(EntityType<ApostleOfCatastropheEntity> type, Level world) {
		super(type, world);
		xpReward = 250;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	public boolean hurt(DamageSource source, float amount) {
		ApostleOfCatastropheParryProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this, source.getEntity());
	...
	public void die(DamageSource source) {
		super.die(source);
		ApostleDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
	...
	public void baseTick() {
		super.baseTick();
		ApostleOfCatastropheOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 85) {
			this.remove(ApostleOfCatastropheEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
