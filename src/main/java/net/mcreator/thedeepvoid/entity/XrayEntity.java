...
import net.mcreator.thedeepvoid.procedures.XrayOnEntityTickUpdateProcedure;
import net.mcreator.thedeepvoid.init.TheDeepVoidModEntities;

public class XrayEntity extends PathfinderMob {
	public XrayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheDeepVoidModEntities.XRAY.get(), world);
	}

	public XrayEntity(EntityType<XrayEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0f);
		xpReward = 0;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		XrayOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
