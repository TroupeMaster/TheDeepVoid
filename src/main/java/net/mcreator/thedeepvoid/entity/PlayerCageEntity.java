...
public class PlayerCageEntity extends Monster {
	public PlayerCageEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheDeepVoidModEntities.PLAYER_CAGE.get(), world);
	}
	...
	public SoundEvent getDeathSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.wither.break_block"));
	}
	...
	public void playerTouch(Player sourceentity) {
		...
		PlayerCagePlayerCollidesWithThisEntityProcedure.execute(this, sourceentity);
	}
