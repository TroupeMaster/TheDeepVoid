...
public class FleshFangsEntity extends Monster implements GeoEntity {
	...
	public FleshFangsEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheDeepVoidModEntities.FLESH_FANGS.get(), world);
	}

	public FleshFangsEntity(EntityType<FleshFangsEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
