...
public class SoulOrbEntity extends PathfinderMob {
	public SoulOrbEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheDeepVoidModEntities.SOUL_ORB.get(), world);
	}

	public SoulOrbEntity(EntityType<SoulOrbEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0f);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		SoulOrbRightClickedOnEntityProcedure.execute(entity, sourceentity);
		return retval;
	}
