...
import net.mcreator.thedeepvoid.procedures.SpawnBoneSpikesOnInitialEntitySpawnProcedure;
import net.mcreator.thedeepvoid.procedures.SpawnBoneSpikesOnEntityTickUpdateProcedure;
import net.mcreator.thedeepvoid.procedures.SpawnBoneSpikesEntityIsHurtProcedure;
...
public class SpawnBoneSpikesEntity extends Monster {
	...
	public SpawnBoneSpikesEntity(EntityType<SpawnBoneSpikesEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(1f);
		xpReward = 0;
		setNoAi(false);
