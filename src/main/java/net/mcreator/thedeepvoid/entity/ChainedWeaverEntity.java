...
public class ChainedWeaverEntity extends PathfinderMob implements GeoEntity {
	...
	public ChainedWeaverEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheDeepVoidModEntities.CHAINED_WEAVER.get(), world);
	}
