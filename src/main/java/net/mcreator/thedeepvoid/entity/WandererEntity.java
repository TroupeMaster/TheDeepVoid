...
public class WandererEntity extends PathfinderMob implements GeoEntity {
	...
	public WandererEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheDeepVoidModEntities.WANDERER.get(), world);
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.sculk.charge"));
	}
	...
	public static void init() {
		SpawnPlacements.register(TheDeepVoidModEntities.WANDERER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
