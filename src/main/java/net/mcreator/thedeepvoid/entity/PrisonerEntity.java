...
import net.mcreator.thedeepvoid.procedures.PrisonerOnEntityTickUpdateProcedure;
import net.mcreator.thedeepvoid.init.TheDeepVoidModEntities;

public class PrisonerEntity extends Monster implements GeoEntity {
	...
	public PrisonerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TheDeepVoidModEntities.PRISONER.get(), world);
	}

	public PrisonerEntity(EntityType<PrisonerEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	public void baseTick() {
		super.baseTick();
		PrisonerOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(PrisonerEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
