...
import net.mcreator.thedeepvoid.potion.TotalBlindnessMobEffect;
import net.mcreator.thedeepvoid.potion.TerrorMobEffect;
import net.mcreator.thedeepvoid.potion.SunderMobEffect;
...
import net.mcreator.thedeepvoid.potion.PitShakeMobEffect;
...
import net.mcreator.thedeepvoid.potion.DestinedToDieMobEffect;
...
public class TheDeepVoidModMobEffects {
	...
	public static final RegistryObject<MobEffect> TOTAL_BLINDNESS = REGISTRY.register("total_blindness", () -> new TotalBlindnessMobEffect());
