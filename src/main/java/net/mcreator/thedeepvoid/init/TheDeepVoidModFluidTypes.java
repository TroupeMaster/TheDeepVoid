...
import net.mcreator.thedeepvoid.fluid.types.LiquidIchorFluidType;
...
public class TheDeepVoidModFluidTypes {
	...
	public static final RegistryObject<FluidType> LIQUID_ICHOR_TYPE = REGISTRY.register("liquid_ichor", () -> new LiquidIchorFluidType());
}
