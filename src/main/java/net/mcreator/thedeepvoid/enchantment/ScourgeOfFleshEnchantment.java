...
public class ScourgeOfFleshEnchantment extends Enchantment {
	...
	protected boolean checkCompatibility(Enchantment ench) {
		return this != ench && !List.of(Enchantments.BANE_OF_ARTHROPODS, Enchantments.SMITE, Enchantments.SHARPNESS, TheDeepVoidModEnchantments.RADIANCE.get()).contains(ench);
	}
