...
public class HarbingerPierceProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (entity instanceof HarbingerOfCataclysmEntity) {
			((HarbingerOfCataclysmEntity) entity).setAnimation("animation.harbinger_pierce");
		}
		...
		TheDeepVoidMod.queueServerWork(10, () -> {
			...
			entity.setDeltaMovement(new Vec3((Math.sin(Math.toRadians(entity.getYRot() + 180)) * 1.8), 0.1, (Math.cos(Math.toRadians(entity.getYRot())) * 1.8)));
		});
