...
public class DarkSteelChainmailDescriptionProcedure {
	@OnlyIn(Dist.CLIENT)
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity, ItemStack itemstack, List<Component> tooltip) {
		if (entity == null || tooltip == null)
			return;
		if (itemstack.getItem() == TheDeepVoidModItems.DARK_STEEL_CHAINMAIL_ARMOR_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.DARK_STEEL_CHAINMAIL_ARMOR_CHESTPLATE.get()
				|| itemstack.getItem() == TheDeepVoidModItems.DARK_STEEL_CHAINMAIL_ARMOR_LEGGINGS.get() || itemstack.getItem() == TheDeepVoidModItems.DARK_STEEL_CHAINMAIL_ARMOR_BOOTS.get()) {
			tooltip.add(Component.literal(""));
			if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getItem() == TheDeepVoidModItems.DARK_STEEL_CHAINMAIL_ARMOR_HELMET.get()
				...
				if (Screen.hasShiftDown()) {
					...
					tooltip.add(Component.literal((" \u00A77-" + Component.translatable("armors.the_deep_void.dark_steel_chainmail.desc").getString())));
				} else {
