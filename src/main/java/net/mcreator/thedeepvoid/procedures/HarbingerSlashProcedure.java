...
public class HarbingerSlashProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (entity instanceof HarbingerOfCataclysmEntity) {
			((HarbingerOfCataclysmEntity) entity).setAnimation("animation.harbinger_slash");
		}
		...
		TheDeepVoidMod.queueServerWork(14, () -> {
			...
			entity.setDeltaMovement(new Vec3((Math.sin(Math.toRadians(entity.getYRot() + 180)) * 0.5), 0.1, (Math.cos(Math.toRadians(entity.getYRot())) * 0.5)));
			{
