	...
	private static void execute(@Nullable Event event, ItemStack itemstack, List<Component> tooltip) {
		...
		if (itemstack.getItem() == TheDeepVoidModItems.ROTTEN_BONE_ARMOR_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.ROTTEN_BONE_ARMOR_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.ROTTEN_BONE_ARMOR_LEGGINGS.get()
			...
			if (Screen.hasShiftDown()) {
				...
				tooltip.add(Component.literal("\u00A79On Armor Ability key pressed:"));
				tooltip.add(Component.literal(" \u00A77-Makes the wearer invisible. When in this state, speed is increased. Upon attacking a foe, the effect ends and double damage is dealt."));
			} else {
		...
		if (itemstack.getItem() == TheDeepVoidModItems.ONYX_ARMOR_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.ONYX_ARMOR_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.ONYX_ARMOR_LEGGINGS.get()
			...
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal(" "));
				tooltip.add(Component.literal("\u00A79When in darkness:"));
				tooltip.add(Component.literal(" \u00A77-Attacks get repeated with half the damage"));
				tooltip.add(Component.literal(" \u00A77-Allows the wearer to see in darkness"));
			} else {
				tooltip.add(Component.literal("\u00A76Press Shift to show abilities"));
			}
		}
		if (itemstack.getItem() == TheDeepVoidModItems.GRIM_ROTTEN_BONE_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.GRIM_ROTTEN_BONE_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.GRIM_ROTTEN_BONE_LEGGINGS.get()
			...
			if (Screen.hasShiftDown()) {
				...
				tooltip.add(Component.literal("\u00A79On Armor Ability key pressed:"));
				tooltip.add(Component.literal(" \u00A77-Makes the wearer invisible. When in this state, speed is increased. Upon attacking a foe, the effect ends and double damage is dealt."));
				tooltip.add(Component.literal("\u00A79When in darkness or when under the effects of Rotten Heart:"));
				tooltip.add(Component.literal(" \u00A77-The armor becomes harder"));
				tooltip.add(Component.literal("\u00A79Upon killing an entity:"));
				tooltip.add(Component.literal(" \u00A77-Resets the cooldown"));
			} else {
				tooltip.add(Component.literal("\u00A76Press Shift to show abilities"));
			}
		}
		if (itemstack.getItem() == TheDeepVoidModItems.LAVENDITE_ARMOR_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.LAVENDITE_ARMOR_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.LAVENDITE_ARMOR_LEGGINGS.get()
			...
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal(" "));
				tooltip.add(Component.literal("\u00A79When attacked:"));
				tooltip.add(Component.literal(" \u00A77-Deflects any projectile"));
			} else {
				tooltip.add(Component.literal("\u00A76Press Shift to show abilities"));
			}
		}
		if (itemstack.getItem() == TheDeepVoidModItems.GRIM_LAVENDITE_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.GRIM_LAVENDITE_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.GRIM_LAVENDITE_LEGGINGS.get()
			...
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal(" "));
				tooltip.add(Component.literal("\u00A79When attacked:"));
				tooltip.add(Component.literal(" \u00A77-Deflects any projectile back at the shooter"));
			} else {
				tooltip.add(Component.literal("\u00A76Press Shift to show abilities"));
			}
		}
		if (itemstack.getItem() == TheDeepVoidModItems.BISMUTH_NETHERITE_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.BISMUTH_NETHERITE_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.BISMUTH_NETHERITE_LEGGINGS.get()
			...
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal(" "));
				tooltip.add(Component.literal("\u00A79When worn:"));
				tooltip.add(Component.literal(" \u00A77-XP heals the wearer"));
			} else {
				tooltip.add(Component.literal("\u00A76Press Shift to show abilities"));
			}
		}
		if (itemstack.getItem() == TheDeepVoidModItems.VOIDRIUM_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.VOIDRIUM_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.VOIDRIUM_LEGGINGS.get()
			...
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal(" "));
				tooltip.add(Component.literal("\u00A79When worn:"));
				tooltip.add(Component.literal(" \u00A77-Negates fall damage"));
				tooltip.add(Component.literal(" \u00A77-Has a chance to repeat the damage, divided by half, dealt"));
				tooltip.add(Component.literal("\u00A79On Armor Ability key pressed:"));
				tooltip.add(Component.literal(" \u00A77-Teleports the wearer"));
				tooltip.add(Component.literal("\u00A79When in darkness:"));
				tooltip.add(Component.literal(" \u00A77-Enhances the wearer's capabilities"));
				tooltip.add(Component.literal("\u00A79When attacked:"));
				tooltip.add(Component.literal(" \u00A77-Damages the attacker"));
			} else {
				tooltip.add(Component.literal("\u00A76Press Shift to show abilities"));
			}
		}
		if (itemstack.getItem() == TheDeepVoidModItems.VOID_CLOAK_CHESTPLATE.get()) {
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal(" "));
				tooltip.add(Component.literal("\u00A79On Armor Ability key pressed:"));
				tooltip.add(Component.literal(" \u00A77-Allows the wearer to phase through walls"));
			} else {
				tooltip.add(Component.literal("\u00A76Press Shift to show abilities"));
			}
		}
		if (itemstack.getItem() == TheDeepVoidModItems.FLESH_ARMOR_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.FLESH_ARMOR_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.FLESH_ARMOR_LEGGINGS.get()
			...
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal(" "));
				tooltip.add(Component.literal("\u00A79When attacked:"));
				tooltip.add(Component.literal(" \u00A77-The armor becomes more resilient and heavier"));
				tooltip.add(Component.literal("\u00A79On Armor Ability key pressed:"));
				tooltip.add(Component.literal(" \u00A77-Unleashes a devastating roar that damages every entity around the wearer based on the resilience of the armor"));
			} else {
				tooltip.add(Component.literal("\u00A76Press Shift to show abilities"));
			}
		}
		if (itemstack.getItem() == TheDeepVoidModItems.ALL_SEEING_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.ALL_SEEING_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.ALL_SEEING_LEGGINGS.get()
			...
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal(" "));
				tooltip.add(Component.literal("\u00A79When entity targets the wearer:"));
				tooltip.add(Component.literal(" \u00A77-The entity is given the glowing effect"));
				tooltip.add(Component.literal(" \u00A77-The wearer gets empowered with strength"));
				tooltip.add(Component.literal("\u00A79On Armor Ability key pressed:"));
				tooltip.add(Component.literal(" \u00A77-Allows the wearer to dash"));
			} else {
				tooltip.add(Component.literal("\u00A76Press Shift to show abilities"));
			}
		}
		if (itemstack.getItem() == TheDeepVoidModItems.CRAWLER_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.CRAWLER_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.CRAWLER_LEGGINGS.get()
			...
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal("\u00A79When worn:"));
				tooltip.add(Component.literal(" \u00A77-Immunity to Rot"));
				tooltip.add(Component.literal(" \u00A77-The wearer becomes invisible, faster and more resistant on bone blocks"));
				tooltip.add(Component.literal("\u00A79On Armor Ability key pressed:"));
				tooltip.add(Component.literal(" \u00A77-The wearer can slow fall"));
			} else {
				tooltip.add(Component.literal("\u00A76Press Shift to show abilities"));
			}
		}
		if (itemstack.getItem() == TheDeepVoidModItems.GRIM_CRAWLER_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.GRIM_CRAWLER_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.GRIM_CRAWLER_LEGGINGS.get()
			...
			if (Screen.hasShiftDown()) {
				...
				tooltip.add(Component.literal(" \u00A77-The wearer can slow fall"));
				tooltip.add(Component.literal("\u00A79When in darkness:"));
				tooltip.add(Component.literal(" \u00A77-All attacks inflict Rot I"));
				tooltip.add(Component.literal(" \u00A77-Allows the wearer to see in darkness"));
			} else {
				tooltip.add(Component.literal("\u00A76Press Shift to show abilities"));
			}
		...
		if (itemstack.getItem() == TheDeepVoidModItems.CULT_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.CULT_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.CULT_LEGGINGS.get()
			...
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal("\u00A79When worn:"));
				tooltip.add(Component.literal(" \u00A77-Grants Void's Blessing"));
				tooltip.add(Component.literal(" \u00A77-The wearer runs faster"));
				tooltip.add(Component.literal(" \u00A77-Light damages the wearer"));
				tooltip.add(Component.literal("\u00A79When attacked:"));
				tooltip.add(Component.literal(" \u00A77-Doubles any damage received"));
			} else {
				tooltip.add(Component.literal("\u00A76Press Shift to show abilities"));
			}
		}
		if (itemstack.getItem() == TheDeepVoidModItems.WEAVER_MASK_HELMET.get()) {
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal("\u00A79When worn:"));
				tooltip.add(Component.literal(" \u00A77-Built Overseers around the wearer are empowered"));
				tooltip.add(Component.literal(" \u00A77-The wearer can no longer heal naturally, they need to attack to heal"));
				tooltip.add(Component.literal("\u00A79When killing a foe:"));
				tooltip.add(Component.literal(" \u00A77-The wearer's health is enhanced until death or the mask is removed. This has a limit and when reached, the wearer will instead get strength and speed temporarily"));
			} else {
				tooltip.add(Component.literal("\u00A76Press Shift to show abilities"));
			}
		}
		if (itemstack.getItem() == TheDeepVoidModItems.WEAVER_ROBE_CHESTPLATE.get()) {
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal("\u00A79When attacking:"));
				tooltip.add(Component.literal(" \u00A77-The wearer is teleported behind the foe, giving a boost to resistance"));
			} else {
				tooltip.add(Component.literal("\u00A76Press Shift to show abilities"));
			}
		}
		if (itemstack.getItem() == TheDeepVoidModItems.SACRED_VOIDRIUM_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.SACRED_VOIDRIUM_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.SACRED_VOIDRIUM_LEGGINGS.get()
			...
			if (Screen.hasShiftDown()) {
				...
				tooltip.add(Component.literal("\u00A79When attacked:"));
				tooltip.add(Component.literal(" \u00A77-Damages the attacker"));
				tooltip.add(Component.literal(" \u00A77-Summons up to three charred spikes around the attacker"));
			} else {
				tooltip.add(Component.literal("\u00A76Press Shift to show abilities"));
			}
		}
