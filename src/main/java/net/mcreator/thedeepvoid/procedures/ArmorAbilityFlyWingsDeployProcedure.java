...
public class ArmorAbilityFlyWingsDeployProcedure {
	public static void execute(Entity entity) {
		...
		components = ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.CHEST) : ItemStack.EMPTY).copy());
		{
			...
			if (_entity instanceof Player _player) {
				_player.getInventory().armor.set(2, new ItemStack(TheDeepVoidModItems.FLY_WINGS_FLY_CHESTPLATE.get()));
				_player.getInventory().setChanged();
			} else if (_entity instanceof LivingEntity _living) {
				_living.setItemSlot(EquipmentSlot.CHEST, new ItemStack(TheDeepVoidModItems.FLY_WINGS_FLY_CHESTPLATE.get()));
			}
		}
		{
		...
		(entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.CHEST) : ItemStack.EMPTY).getOrCreateTag().putDouble("time", ((double) DeepVoidConfigConfiguration.FLYWINGSDURATION.get()));
	}
}
