	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (itemstack.getOrCreateTag().getDouble("deep_void:rounds") > 0) {
			...
			if (world instanceof Level)
				((Level) world).playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("the_deep_void:heresy_shoot")), SoundSource.PLAYERS, 3, 1, false);
					...
					if (itemstack.getOrCreateTag().getBoolean("deep_void:goldBlood") == true) {
						{
							...
							if (!projectileLevel.isClientSide()) {
								...
								}.getArrow(projectileLevel, entity, (float) (double) DeepVoidConfigConfiguration.HERESYGOLDENBLOODSHOTSHOTGUN.get(), 0, (byte) 1);
					...
					} else {
						{
							...
							if (!projectileLevel.isClientSide()) {
								...
								}.getArrow(projectileLevel, entity, (float) (double) DeepVoidConfigConfiguration.HERESYBLOODSHOTSHOTGUN.get(), 0);
								_entityToSpawn.setPos(_shootFrom.getX(), _shootFrom.getEyeY() - 0.1, _shootFrom.getZ());
				...
				if (itemstack.getOrCreateTag().getBoolean("deep_void:goldBlood") == true) {
					{
						...
						if (!projectileLevel.isClientSide()) {
							...
							}.getArrow(projectileLevel, entity, (float) (double) DeepVoidConfigConfiguration.HERESYGOLDENBLOODSHOT.get(), 0, (byte) 2);
							_entityToSpawn.setPos(_shootFrom.getX(), _shootFrom.getEyeY() - 0.1, _shootFrom.getZ());
				...
				} else {
					{
						...
						if (!projectileLevel.isClientSide()) {
							...
							}.getArrow(projectileLevel, entity, (float) (double) DeepVoidConfigConfiguration.HERESYBLOODSHOT.get(), 0, (byte) 1);
							_entityToSpawn.setPos(_shootFrom.getX(), _shootFrom.getEyeY() - 0.1, _shootFrom.getZ());
						...
						if (itemstack.getOrCreateTag().getBoolean("deep_void:goldBlood") == true) {
							{
								...
								if (!projectileLevel.isClientSide()) {
									...
									}.getArrow(projectileLevel, entity, (float) ((double) DeepVoidConfigConfiguration.HERESYGOLDENBLOODSHOT.get() + 0.5), 0, (byte) 3);
									_entityToSpawn.setPos(_shootFrom.getX(), _shootFrom.getEyeY() - 0.1, _shootFrom.getZ());
						...
						} else {
							{
								...
								if (!projectileLevel.isClientSide()) {
									...
									}.getArrow(projectileLevel, entity, (float) (double) DeepVoidConfigConfiguration.HERESYBLOODSHOT.get(), 0, (byte) 2);
									_entityToSpawn.setPos(_shootFrom.getX(), _shootFrom.getEyeY() - 0.1, _shootFrom.getZ());
			...
			if (entity instanceof LivingEntity _livEnt64 && _livEnt64.hasEffect(MobEffects.ABSORPTION)) {
					...
					if (entity instanceof LivingEntity _entity)
						_entity.setHealth((float) Math.ceil((entity instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) - ((entity instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1)
								* ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getItem() == TheDeepVoidModItems.GUNSLINGER_HELMET.get()
										...
										&& (entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).getItem() == TheDeepVoidModItems.GUNSLINGER_BOOTS.get() ? 30 : 45))
								/ 100));
				} else {
					if (entity instanceof LivingEntity _entity)
						_entity.setHealth((float) Math.ceil((entity instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) - ((entity instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1)
								* ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getItem() == TheDeepVoidModItems.GUNSLINGER_HELMET.get()
										&& (entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.CHEST) : ItemStack.EMPTY).getItem() == TheDeepVoidModItems.GUNSLINGER_CHESTPLATE.get()
										&& (entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.LEGS) : ItemStack.EMPTY).getItem() == TheDeepVoidModItems.GUNSLINGER_LEGGINGS.get()
										&& (entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).getItem() == TheDeepVoidModItems.GUNSLINGER_BOOTS.get() ? 20 : 30))
								/ 100));
				}
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
