...
public class AmbrosialCureFinishUsingProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof LivingEntity _livEnt0 && _livEnt0.hasEffect(TheDeepVoidModMobEffects.AMBROSIA_WITHDRAWAL.get())) {
			...
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				_entity.addEffect(new MobEffectInstance(TheDeepVoidModMobEffects.AMBROSIA_WITHDRAWAL.get(), (int) (duration - 250), (int) (level - 1), true, true));
		}
	}
}
