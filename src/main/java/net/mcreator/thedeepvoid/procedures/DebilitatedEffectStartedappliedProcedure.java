...
public class DebilitatedEffectStartedappliedProcedure {
	public static void execute(Entity entity) {
		...
		if (!(((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ARMOR)
				.hasModifier((new AttributeModifier(UUID.fromString("b62dcadb-d9b4-46da-b37c-6378ea720d21"), "debilitatedArmor", (-0.6), AttributeModifier.Operation.MULTIPLY_TOTAL)))))
			((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ARMOR)
					.addTransientModifier((new AttributeModifier(UUID.fromString("b62dcadb-d9b4-46da-b37c-6378ea720d21"), "debilitatedArmor", (-0.6), AttributeModifier.Operation.MULTIPLY_TOTAL)));
		if (!(((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ARMOR_TOUGHNESS)
				.hasModifier((new AttributeModifier(UUID.fromString("d747b3a8-1b6a-48bb-a3fe-d9de22cb7fc8"), "debilitatedArmorTough", (-0.6), AttributeModifier.Operation.MULTIPLY_TOTAL)))))
			((LivingEntity) entity).getAttribute(net.minecraft.world.entity.ai.attributes.Attributes.ARMOR_TOUGHNESS)
					.addTransientModifier((new AttributeModifier(UUID.fromString("d747b3a8-1b6a-48bb-a3fe-d9de22cb7fc8"), "debilitatedArmorTough", (-0.6), AttributeModifier.Operation.MULTIPLY_TOTAL)));
