...
public class SulfurTntBlockDestroyedByExplosionProcedure {
		...
		}
		{
			...
			for (Entity entityiterator : _entfound) {
				if (entityiterator instanceof SulfurTntEntityEntity) {
					if (entityiterator instanceof SulfurTntEntityEntity _datEntSetI)
						_datEntSetI.getEntityData().set(SulfurTntEntityEntity.DATA_explode, Mth.nextInt(RandomSource.create(), 50, 70));
				}
			}
		}
	}
