...
public class SentientArmorDescriptionProcedure {
	@OnlyIn(Dist.CLIENT)
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity, ItemStack itemstack, List<Component> tooltip) {
		if (entity == null || tooltip == null)
			return;
		if (itemstack.getItem() == TheDeepVoidModItems.SENTIENT_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.SENTIENT_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.SENTIENT_LEGGINGS.get()
				|| itemstack.getItem() == TheDeepVoidModItems.SENTIENT_BOOTS.get()) {
			tooltip.add(Component.literal(""));
			if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getItem() == TheDeepVoidModItems.SENTIENT_HELMET.get()
				...
				if (Screen.hasShiftDown()) {
					...
					tooltip.add(Component.literal((" \u00A77-" + Component.translatable("armors.the_deep_void.sentient.worn1").getString())));
					tooltip.add(Component.literal(("\u00A76" + Component.translatable("armors.the_deep_void.key_press").getString())));
					tooltip.add(Component.literal((" \u00A77-" + Component.translatable("armors.the_deep_void.sentient.ability").getString())));
				} else {
