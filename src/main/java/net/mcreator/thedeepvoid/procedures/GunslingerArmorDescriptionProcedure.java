...
public class GunslingerArmorDescriptionProcedure {
	@OnlyIn(Dist.CLIENT)
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity, ItemStack itemstack, List<Component> tooltip) {
		if (entity == null || tooltip == null)
			return;
		if (itemstack.getItem() == TheDeepVoidModItems.GUNSLINGER_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.GUNSLINGER_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.GUNSLINGER_LEGGINGS.get()
				|| itemstack.getItem() == TheDeepVoidModItems.GUNSLINGER_BOOTS.get()) {
			...
			if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getItem() == TheDeepVoidModItems.GUNSLINGER_HELMET.get()
				...
				if (Screen.hasShiftDown()) {
					...
					tooltip.add(Component.literal((" \u00A77-" + Component.translatable("armors.the_deep_void.gunslinger.worn1").getString())));
					tooltip.add(Component.literal((" \u00A77-" + Component.translatable("armors.the_deep_void.gunslinger.worn2").getString())));
					tooltip.add(Component.literal(("\u00A76" + Component.translatable("armors.the_deep_void.lavendite.when_attacked").getString())));
					tooltip.add(Component.literal((" \u00A77-" + Component.translatable("armors.the_deep_void.gunslinger.attacked1").getString())));
					tooltip.add(Component.literal(("\u00A76" + Component.translatable("armors.the_deep_void.key_press").getString())));
					tooltip.add(Component.literal((" \u00A77-" + Component.translatable("armors.the_deep_void.gunslinger.ability1").getString())));
				} else {
				...
				if (Screen.hasShiftDown()) {
					...
					tooltip.add(Component.literal((" \u00A77-" + Component.translatable("armors.the_deep_void.gunslinger.worn1").getString())));
					tooltip.add(Component.literal((" \u00A77-" + Component.translatable("armors.the_deep_void.gunslinger.worn2").getString())));
					tooltip.add(Component.literal(("\u00A77" + Component.translatable("armors.the_deep_void.lavendite.when_attacked").getString())));
					tooltip.add(Component.literal((" \u00A77-" + Component.translatable("armors.the_deep_void.gunslinger.attacked1").getString())));
