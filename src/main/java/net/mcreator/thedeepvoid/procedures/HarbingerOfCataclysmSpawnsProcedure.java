...
public class HarbingerOfCataclysmSpawnsProcedure {
			...
			for (Entity entityiterator : _entfound) {
				if (entityiterator instanceof Player) {
					...
					if (entityiterator instanceof Player _player && !_player.level().isClientSide())
						_player.displayClientMessage(Component.literal("\u00A7c\u00A7kDisc \u00A7cDealing With The Devil - by Darren Curtis Music \u00A7c\u00A7kDisc"), true);
				}
			}
		}
	}
