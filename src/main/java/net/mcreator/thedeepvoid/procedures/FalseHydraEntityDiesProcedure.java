...
public class FalseHydraEntityDiesProcedure {
					...
					for (Entity entityiterator : _entfound) {
						if (entityiterator instanceof Player) {
							...
							if (!(entityiterator instanceof ServerPlayer _plr7 && _plr7.level() instanceof ServerLevel
									&& _plr7.getAdvancements().getOrStartProgress(_plr7.server.getAdvancements().getAdvancement(new ResourceLocation("the_deep_void:copycat"))).isDone())) {
							...
							if (entityiterator instanceof LivingEntity _livEnt9 && _livEnt9.hasEffect(TheDeepVoidModMobEffects.BRAIN_FOG.get())) {
