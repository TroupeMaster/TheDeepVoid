	...
	private static void execute(@Nullable Event event, Entity entity, ItemStack itemstack, List<Component> tooltip) {
		...
		if (itemstack.getItem() == TheDeepVoidModItems.VOIDRIUM_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.SACRED_VOIDRIUM_HELMET.get()) {
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.voidrium.when_darkness").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.voidrium_helmet.in_darkness").getString())));
			} else {
		...
		if (itemstack.getItem() == TheDeepVoidModItems.VOIDRIUM_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.SACRED_VOIDRIUM_CHESTPLATE.get()) {
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.voidrium_chestplate.when_half_health").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.voidrium_chestplate.half_health").getString())));
			} else {
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.press_shift").getString())));
			}
		}
		if (itemstack.getItem() == TheDeepVoidModItems.VOIDRIUM_LEGGINGS.get() || itemstack.getItem() == TheDeepVoidModItems.SACRED_VOIDRIUM_LEGGINGS.get()) {
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.voidrium.when_darkness").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.voidrium_leggings.in_darkness").getString())));
			} else {
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.press_shift").getString())));
			}
		}
		if (itemstack.getItem() == TheDeepVoidModItems.VOIDRIUM_BOOTS.get() || itemstack.getItem() == TheDeepVoidModItems.SACRED_VOIDRIUM_BOOTS.get()) {
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.voidrium_boots.when_worn").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.voidrium_boots.worn").getString())));
			} else {
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.press_shift").getString())));
			}
		}
		if ((itemstack.getItem() == TheDeepVoidModItems.VOIDRIUM_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.VOIDRIUM_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.VOIDRIUM_LEGGINGS.get()
			...
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.voidrium.when_darkness").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.voidrium.in_darkness").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.voidrium.key_press").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.voidrium.on_key_press").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.voidrium.when_attacked").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.voidrium.attacked").getString())));
			}
		}
		if ((itemstack.getItem() == TheDeepVoidModItems.SACRED_VOIDRIUM_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.SACRED_VOIDRIUM_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.SACRED_VOIDRIUM_LEGGINGS.get()
			...
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.voidrium.when_darkness").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.soul_voidrium.in_darkness").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.voidrium.key_press").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.soul_voidrium.on_key_press").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.voidrium.when_attacked").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.voidrium.attacked").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.soul_voidrium.attacked").getString())));
			}
		}
	}
}
