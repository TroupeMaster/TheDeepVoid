...
public class UndertakerItemTakenFromSlotProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(1)).getItem() : ItemStack.EMPTY)
			...
			}
			{
				...
				for (Entity entityiterator : _entfound) {
					if (entityiterator instanceof UndertakerEntity && (entityiterator.getStringUUID()).equals(entity.getPersistentData().getString("undertakerUuid"))) {
						entityiterator.getPersistentData().putDouble("firstTradeQut", 0);
					}
				}
			}
			...
			}
			{
				...
				for (Entity entityiterator : _entfound) {
					if (entityiterator instanceof UndertakerEntity && (entityiterator.getStringUUID()).equals(entity.getPersistentData().getString("undertakerUuid"))) {
						entityiterator.getPersistentData().putDouble("secondTradeQut", 0);
					}
				}
			}
		} else if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(1)).getItem() : ItemStack.EMPTY)
			...
			}
			{
				...
				for (Entity entityiterator : _entfound) {
					if (entityiterator instanceof UndertakerEntity && (entityiterator.getStringUUID()).equals(entity.getPersistentData().getString("undertakerUuid"))) {
						entityiterator.getPersistentData().putDouble("thirdTradeQut", 0);
					}
				}
			}
		} else if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(1)).getItem() : ItemStack.EMPTY)
			...
			}
			{
				...
				for (Entity entityiterator : _entfound) {
					if (entityiterator instanceof UndertakerEntity && (entityiterator.getStringUUID()).equals(entity.getPersistentData().getString("undertakerUuid"))) {
						entityiterator.getPersistentData().putDouble("fourthTradeQut", 0);
					}
				}
			}
		} else if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(1)).getItem() : ItemStack.EMPTY)
			...
			}
			{
				...
				for (Entity entityiterator : _entfound) {
					if (entityiterator instanceof UndertakerEntity && (entityiterator.getStringUUID()).equals(entity.getPersistentData().getString("undertakerUuid"))) {
						entityiterator.getPersistentData().putDouble("potionTradeQut", 0);
					}
				}
			}
		} else if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(1)).getItem() : ItemStack.EMPTY)
			...
			}
			{
				...
				for (Entity entityiterator : _entfound) {
					if (entityiterator instanceof UndertakerEntity && (entityiterator.getStringUUID()).equals(entity.getPersistentData().getString("undertakerUuid"))) {
						entityiterator.getPersistentData().putDouble("conversionQut", 0);
					}
				}
			}
		}
