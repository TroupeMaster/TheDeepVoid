...
public class KnifeBandolierSmallSpinProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (world instanceof ServerLevel projectileLevel) {
			...
			}.getArrow(projectileLevel, entity, (float) ((double) DeepVoidConfigConfiguration.KNIFEBANDOLIERKNIFE.get() - 0.5), 0) : new Object() {
				public Projectile getArrow(Level level, Entity shooter, float damage, int knockback) {
			...
			}.getArrow(projectileLevel, entity, (float) ((double) DeepVoidConfigConfiguration.KNIFEBANDOLIERKNIFE.get() - 0.5), 0));
			_entityToSpawn.setPos((entity.getX()), (entity.getY() + 1.6), (entity.getZ()));
			_entityToSpawn.shoot(1, 0, 0, (float) 1.5, 1);
		...
		if (world instanceof ServerLevel projectileLevel) {
			...
			_entityToSpawn.setPos((entity.getX()), (entity.getY() + 1.6), (entity.getZ()));
			_entityToSpawn.shoot(0, 0, 1, (float) 1.5, 1);
			projectileLevel.addFreshEntity(_entityToSpawn);
		}
		if (world instanceof ServerLevel projectileLevel) {
			Projectile _entityToSpawn = (Math.random() < 0.5 ? new Object() {
