	...
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if ((entity instanceof LivingEntity _entUseItem0 ? _entUseItem0.getUseItem() : ItemStack.EMPTY).getItem() == TheDeepVoidModItems.SHADESTORM.get()) {
			if ((entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Items.ARROW)) : false) || new Object() {
				...
				if ((entity instanceof LivingEntity _entUseItem4 ? _entUseItem4.getUseItem() : ItemStack.EMPTY).getOrCreateTag().getDouble("deep_void:cooldown") >= 2) {
					(entity instanceof LivingEntity _entUseItem6 ? _entUseItem6.getUseItem() : ItemStack.EMPTY).getOrCreateTag().putDouble("deep_void:cooldown", 0);
					{
					...
					(entity instanceof LivingEntity _entUseItem16 ? _entUseItem16.getUseItem() : ItemStack.EMPTY).getOrCreateTag().putDouble("deep_void:cooldown",
							((entity instanceof LivingEntity _entUseItem14 ? _entUseItem14.getUseItem() : ItemStack.EMPTY).getOrCreateTag().getDouble("deep_void:cooldown") + 1));
				}
			}
		}
	}
