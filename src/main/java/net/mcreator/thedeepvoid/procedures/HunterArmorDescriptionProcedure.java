	...
	private static void execute(@Nullable Event event, Entity entity, ItemStack itemstack, List<Component> tooltip) {
		...
		if ((itemstack.getItem() == TheDeepVoidModItems.HUNTERS_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.HUNTERS_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.HUNTERS_LEGGINGS.get()
			...
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.rotten_bone.key_press").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.hunter.on_key_press").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.hunter.jumping").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.hunter.on_jumping").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.voidrium_boots.when_worn").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.hunter.step_height").getString())));
				...
				if (itemstack.getItem() == TheDeepVoidModItems.HUNTERS_HELMET.get()) {
					tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.hunter.sprinting").getString())));
					tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.hunter.on_sprinting").getString())));
				}
			} else {
