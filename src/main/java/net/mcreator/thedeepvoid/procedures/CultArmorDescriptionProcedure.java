...
public class CultArmorDescriptionProcedure {
	@OnlyIn(Dist.CLIENT)
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity, ItemStack itemstack, List<Component> tooltip) {
		...
		if ((itemstack.getItem() == TheDeepVoidModItems.CULT_HELMET.get() || itemstack.getItem() == TheDeepVoidModItems.CULT_CHESTPLATE.get() || itemstack.getItem() == TheDeepVoidModItems.CULT_LEGGINGS.get()
			...
			if (Screen.hasShiftDown()) {
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.cult.when_worn").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.cult.worn1").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.cult.worn2").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.cult.worn3").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.cult.when_attacked").getString())));
				tooltip.add(Component.literal((Component.translatable("armors.the_deep_void.cult.attacked").getString())));
			} else {
