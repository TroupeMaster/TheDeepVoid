...
public class HiveWatcherWhileMovingXProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		{
			final Vec3 _center = new Vec3(x, y, z);
			List<Entity> _entfound = world.getEntitiesOfClass(Entity.class, new AABB(_center, _center).inflate(((double) DeepVoidConfigConfiguration.HIVEWATCHERATTACKRADIUS.get()) / 2d), e -> true).stream()
