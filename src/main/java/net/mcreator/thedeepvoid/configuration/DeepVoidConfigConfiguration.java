...
public class DeepVoidConfigConfiguration {
	...
	public static final ForgeConfigSpec.ConfigValue<Double> BOSSDAMAGECAP;
	...
	public static final ForgeConfigSpec.ConfigValue<Double> APOSTLETELEPORTMELEE;
	public static final ForgeConfigSpec.ConfigValue<Double> APOSTLETHREEKNIVES;
	...
	public static final ForgeConfigSpec.ConfigValue<Double> APOSTLEMISSGRABMELEE;
	public static final ForgeConfigSpec.ConfigValue<Double> APOSTLESECONDPHASE;
	public static final ForgeConfigSpec.ConfigValue<Double> APOSTLEPARRY;
	...
	public static final ForgeConfigSpec.ConfigValue<Double> SOULSEEKERREPEATEDDAMAGE;
	public static final ForgeConfigSpec.ConfigValue<Double> VOODOODOLL;
	public static final ForgeConfigSpec.ConfigValue<Double> SOULSEEKERTHROWN;
	...
	public static final ForgeConfigSpec.ConfigValue<Double> VOIDMATTERGREATSWORD;
	public static final ForgeConfigSpec.ConfigValue<Double> RUSTYCLAWSEXTRADAMAGE;
	...
	static {
		...
		BOSSDAMAGECAP = BUILDER.comment("Damage should deal (damage + percentage of damage beyond the cap) when reached").define("BossDamageCap", (double) 10);
		DAMAGECAPPERCENTAGE = BUILDER.comment("The percentage of the damage that exceeded the cap that should be dealt").define("DamageCapPercentage", (double) 0.6);
		...
		APOSTLETELEPORTMELEE = BUILDER.comment("Damage").define("ApostleTeleportMelee", (double) 8);
		APOSTLETHREEKNIVES = BUILDER.comment("Damage of each knife (velocity increases that number)").define("ApostleThreeKnives", (double) 4);
		APOSTLESLASH = BUILDER.comment("Damage").define("ApostleSlash", (double) 14);
		APOSTLEJUMPSHOOT = BUILDER.comment("Damage of each knife (velocity increases that number)").define("ApostleJumpShoot", (double) 7);
		APOSTLESPIN = BUILDER.comment("Damage each tick").define("ApostleSpin", (double) 5);
		APOSTLEGRAB = BUILDER.comment("Damage repeated three times (ignores armor)").define("ApostleGrab", (double) 7);
		APOSTLEMISSGRABMELEE = BUILDER.comment("Damage").define("ApostleMissGrabMelee", (double) 10);
		APOSTLESECONDPHASE = BUILDER.comment("When under Max Health/Config Number, second phase is active").define("ApostleSecondPhase", (double) 1.8);
		APOSTLEPARRY = BUILDER.comment("Damage in an AOE on successful parry (only damages the attacker)").define("ApostleParry", (double) 10);
		BUILDER.pop();
		...
		SOULSEEKERREPEATEDDAMAGE = BUILDER.comment("Damage dealt after the first hit").define("SoulSeekerRepeatedDamage", (double) 6);
		VOODOODOLL = BUILDER.comment("Damage dealt in an AOE each tick").define("VoodooDoll", (double) 2);
		SOULSEEKERTHROWN = BUILDER.comment("Damage dealt in an AOE each tick").define("SoulSeekerThrown", (double) 5);
		...
		VOIDMATTERGREATSWORD = BUILDER.comment("Damage dealt in an AOE").define("VoidMatterGreatsword", (double) 9);
		RUSTYCLAWSEXTRADAMAGE = BUILDER.comment("Damage dealt if the entity does not have broken armor (full damage, not an addition)").define("RustyClawsExtraDamage", (double) 6);
