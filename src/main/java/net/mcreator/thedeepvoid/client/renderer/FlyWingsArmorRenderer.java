...
import net.mcreator.thedeepvoid.item.model.FlyWingsModel;
import net.mcreator.thedeepvoid.item.FlyWingsItem;

public class FlyWingsArmorRenderer extends GeoArmorRenderer<FlyWingsItem> {
	public FlyWingsArmorRenderer() {
		super(new FlyWingsModel());
	...
	@Override
	public RenderType getRenderType(FlyWingsItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
