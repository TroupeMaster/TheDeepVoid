...
public class BloodSpikeRenderer extends EntityRenderer<BloodSpikeEntity> {
	private static final ResourceLocation texture = new ResourceLocation("the_deep_void:textures/entities/blood_spike.png");
	...
	@Override
	public void render(BloodSpikeEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
