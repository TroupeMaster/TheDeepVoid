...
public class BarbedArrowRenderer extends EntityRenderer<BarbedArrowEntity> {
	private static final ResourceLocation texture = new ResourceLocation("the_deep_void:textures/entities/barbed_arrow.png");
	...
	@Override
	public void render(BarbedArrowEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
