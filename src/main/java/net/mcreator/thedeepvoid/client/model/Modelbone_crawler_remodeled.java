...
public class Modelbone_crawler_remodeled<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("the_deep_void", "modelbone_crawler_remodeled"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 19).addBox(-5.0F, -3.0F, 0.0F, 10.0F, 4.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(10, 0)
				.addBox(-5.0F, -3.1F, 2.0F, 5.0F, 0.0F, 19.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(0.0F, -3.1F, 2.0F, 5.0F, 0.0F, 19.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 22.0F, -6.0F));
