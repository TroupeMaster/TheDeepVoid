...
import net.mcreator.thedeepvoid.procedures.TheHarvestSlashProcedure;
import net.mcreator.thedeepvoid.procedures.TheHarvestRightclickedProcedure;
import net.mcreator.thedeepvoid.procedures.TheHarvestHasItemGlowingEffectProcedure;
...
public class TheHarvestItem extends SwordItem {
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		TheHarvestRightclickedProcedure.execute(entity.level(), entity, sourceentity, itemstack);
		return retval;
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		TheHarvestSlashProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject());
		return ar;
	}
	...
	public boolean isFoil(ItemStack itemstack) {
		return TheHarvestHasItemGlowingEffectProcedure.execute(itemstack);
	}
}
