...
import net.mcreator.thedeepvoid.procedures.OnyxNaginataToolInHandTickProcedure;
import net.mcreator.thedeepvoid.procedures.BoneSwordLivingEntityIsHitWithToolProcedure;
import net.mcreator.thedeepvoid.init.TheDeepVoidModItems;

public class OnyxNaginataItem extends SwordItem {
	public OnyxNaginataItem() {
		super(new Tier() {
			public int getUses() {
				return 1561;
			}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			OnyxNaginataToolInHandTickProcedure.execute(world, entity);
	}
}
