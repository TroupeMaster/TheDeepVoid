...
import net.mcreator.thedeepvoid.item.inventory.NecrosedSkinBackpackInventoryCapability;

import javax.annotation.Nullable;

import io.netty.buffer.Unpooled;

public class NecrosedSkinBackpackItem extends Item {
	public NecrosedSkinBackpackItem() {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Necrosed Skin Backpack");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new NecrosedSkinBackpackGUIMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
	...
	public ICapabilityProvider initCapabilities(ItemStack stack, @Nullable CompoundTag compound) {
		return new NecrosedSkinBackpackInventoryCapability();
	}
