...
public class AnimosityItem extends SwordItem {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A77The first hit on an entity deals 1.5x more damage, 2x for players. This resets if the player dies"));
		list.add(Component.literal("\u00A77Deals more damage to players"));
		list.add(Component.literal("\u00A77Hides the name of the killer"));
