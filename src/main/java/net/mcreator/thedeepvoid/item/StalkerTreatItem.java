...
import net.mcreator.thedeepvoid.procedures.StalkerTreatRightclickedProcedure;

import java.util.List;

public class StalkerTreatItem extends Item {
	public StalkerTreatItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		StalkerTreatRightclickedProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity);
		return ar;
	}
}
