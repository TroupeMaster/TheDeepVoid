...
import net.mcreator.thedeepvoid.procedures.BloodstoneArmorHelmetTickEventProcedure;
import net.mcreator.thedeepvoid.init.TheDeepVoidModItems;

import com.google.common.collect.Iterables;

public abstract class BloodstoneArmorItem extends ArmorItem {
	public BloodstoneArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends BloodstoneArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "the_deep_void:textures/models/armor/bloodstone__layer_1.png";
		}
		...
		public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
			...
			if (entity instanceof Player player && Iterables.contains(player.getArmorSlots(), itemstack)) {
				BloodstoneArmorHelmetTickEventProcedure.execute(world, entity, itemstack);
			}
		}
	}
	...
	public static class Leggings extends BloodstoneArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "the_deep_void:textures/models/armor/bloodstone__layer_2.png";
		}
