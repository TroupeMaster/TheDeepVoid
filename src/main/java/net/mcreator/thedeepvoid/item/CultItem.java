...
import net.mcreator.thedeepvoid.procedures.CultFullArmorProcedure;
...
public abstract class CultItem extends ArmorItem {
	public CultItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(TheDeepVoidModItems.MOURNER_HIDE.get()));
			}
	...
	public static class Helmet extends CultItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "the_deep_void:textures/models/armor/cult__layer_1.png";
		}
	}
	...
	public static class Chestplate extends CultItem {
		...
		public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
			...
			if (entity instanceof Player player && Iterables.contains(player.getArmorSlots(), itemstack)) {
				CultFullArmorProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity);
			}
		}
	}
	...
	public static class Leggings extends CultItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "the_deep_void:textures/models/armor/cult__layer_2.png";
		}
	}
