...
public class Modelgoo_spitter<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "goo_spitter"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 19)
						.addBox(-5.0F, -3.0F, 0.0F, 10.0F, 4.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(63, 0)
						.addBox(-6.0F, -4.5F, 12.0F, 12.0F, 6.0F, 10.0F, new CubeDeformation(0.0F)),
