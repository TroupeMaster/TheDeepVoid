...
public class Modeldeath_maw<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "death_maw"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 88)
						.addBox(-11.0F, 15.0F, 1.0F, 22.0F, 3.0F, 32.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-17.0F, 0.0F, 0.0F, 34.0F, 15.0F, 34.0F, new CubeDeformation(0.0F)).texOffs(0, 49)
						.addBox(-14.0F, -11.0F, 3.0F, 28.0F, 11.0F, 28.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(68, 182)
						.addBox(-15.0F, -7.0F, -13.0F, 12.0F, 14.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(164, 182)
						.addBox(-15.0F, 7.0F, -13.0F, 12.0F, 2.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(116, 182)
						.addBox(2.0F, -5.0F, -12.0F, 12.0F, 14.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(112, 72)
						.addBox(2.0F, 9.0F, -12.0F, 12.0F, 2.0F, 12.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition left_leg1 = partdefinition.addOrReplaceChild("left_leg1",
				CubeListBuilder.create().texOffs(112, 208)
						.addBox(14.0F, -25.0F, 0.0F, 9.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(68, 123)
						.addBox(17.0F, -16.0F, 0.0F, 9.0F, 28.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = left_leg1
		...
		PartDefinition right_leg1 = partdefinition.addOrReplaceChild("right_leg1",
				CubeListBuilder.create().texOffs(212, 181)
						.addBox(-23.0F, -25.0F, 0.0F, 9.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 204)
						.addBox(-26.0F, -16.0F, 0.0F, 9.0F, 28.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-15.0F, 14.0F, -9.0F));
		...
		PartDefinition cube_r14 = right_leg1
		...
		PartDefinition left_leg2 = partdefinition.addOrReplaceChild("left_leg2",
				CubeListBuilder.create().texOffs(130, 208)
						.addBox(14.0F, -25.0F, 0.0F, 9.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(86, 123)
						.addBox(17.0F, -16.0F, 0.0F, 9.0F, 28.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r16 = left_leg2
		...
		PartDefinition right_leg2 = partdefinition.addOrReplaceChild("right_leg2",
				CubeListBuilder.create().texOffs(212, 190)
						.addBox(-23.0F, -25.0F, 0.0F, 9.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(18, 204)
						.addBox(-26.0F, -16.0F, 0.0F, 9.0F, 28.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-15.0F, 14.0F, 12.0F));
		...
		PartDefinition cube_r18 = right_leg2
		...
		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(176, 72).addBox(-2.0F, -2.0F, -22.0F, 4.0F, 4.0F, 23.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r19 = left_arm.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(112, 49)
						.addBox(-9.0F, 0.0F, -43.0F, 18.0F, 0.0F, 23.0F, new CubeDeformation(0.0F)).texOffs(136, 23)
						.addBox(-2.0F, -1.5F, -23.0F, 4.0F, 3.0F, 23.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r20 = right_arm.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(136, 0)
						.addBox(-9.0F, 0.0F, -43.0F, 18.0F, 0.0F, 23.0F, new CubeDeformation(0.0F)).texOffs(176, 126)
						.addBox(-2.0F, -1.5F, -23.0F, 4.0F, 3.0F, 23.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, -20.0F, 0.0F, -0.6981F, 0.0F));
