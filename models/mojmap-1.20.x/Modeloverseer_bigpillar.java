...
public class Modeloverseer_bigpillar<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "overseer_bigpillar"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition pillar = partdefinition.addOrReplaceChild("pillar",
				CubeListBuilder.create().texOffs(0, 32)
						.addBox(-8.0F, -16.0F, -8.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(64, 32)
						.addBox(-8.0F, -32.0F, -8.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)).texOffs(64, 32)
						.addBox(-8.0F, -32.0F, -8.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)),
