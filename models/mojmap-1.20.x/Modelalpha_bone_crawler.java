...
public class Modelalpha_bone_crawler<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "alpha_bone_crawler"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 32)
						.addBox(-8.0F, -4.0F, 0.0F, 16.0F, 7.0F, 22.0F, new CubeDeformation(0.0F)).texOffs(0, 86)
						.addBox(-1.0F, -7.0F, 0.0F, 2.0F, 3.0F, 22.0F, new CubeDeformation(0.0F)).texOffs(76, 32)
						.addBox(0.0F, -15.0F, -3.0F, 0.0F, 11.0F, 28.0F, new CubeDeformation(0.0F)).texOffs(0, 61)
						.addBox(-8.0F, 3.0F, 0.0F, 16.0F, 3.0F, 22.0F, new CubeDeformation(0.0F)).texOffs(84, 0)
						.addBox(-7.0F, 3.0F, 1.0F, 14.0F, 1.0F, 20.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(0.0F, -4.1F, 3.0F, 10.0F, 0.0F, 32.0F, new CubeDeformation(0.0F)).texOffs(0, 0).mirror()
						.addBox(-10.0F, -4.1F, 3.0F, 10.0F, 0.0F, 32.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offset(0.0F, 18.0F, -11.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(48, 87)
						.addBox(-7.0F, -3.0F, -10.0F, 14.0F, 7.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(76, 71)
						.addBox(-11.0F, 0.0F, -16.0F, 22.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 18.0F, -11.0F));

		PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(96, 87).mirror()
						.addBox(-2.0F, -5.0F, -11.0F, 3.0F, 11.0F, 13.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-3.0F, 0.0F, -8.0F, 0.0F, -0.0873F, 0.0F));

		PartDefinition cube_r2 = head
				.addOrReplaceChild("cube_r2",
						CubeListBuilder.create().texOffs(96, 87).addBox(-1.0F, -5.0F, -11.0F, 3.0F, 11.0F, 13.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(3.0F, 0.0F, -8.0F, 0.0F, 0.0873F, 0.0F));

		PartDefinition left_leg1 = partdefinition.addOrReplaceChild(
				"left_leg1", CubeListBuilder.create().texOffs(74, 104).addBox(-2.4617F, -16.113F, -2.0F, 5.0F, 17.0F,
						5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.0F, 19.0F, 0.0F, 0.0F, 0.0F, 1.0908F));

		PartDefinition cube_r3 = left_leg1.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(84, 21).addBox(-7.0F, -3.0F, 0.5F, 13.0F, 4.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = left_leg1.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(48, 104)
						.addBox(-7.0F, -16.0F, 0.5F, 13.0F, 17.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 111)
						.addBox(-1.0F, -11.0F, -1.0F, 3.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition left_leg0 = partdefinition.addOrReplaceChild("left_leg0",
				CubeListBuilder.create().texOffs(74, 104).addBox(-2.4617F, -16.113F, -2.0F, 5.0F, 17.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.0F, 18.0F, -5.0F, 0.2657F, 0.1685F, 1.1364F));

		PartDefinition cube_r5 = left_leg0.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(84, 21).addBox(-7.0F, -3.0F, 0.5F, 13.0F, 4.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.4617F, -9.113F, 0.0F, 0.0F, 0.0F, 1.5708F));
		...
		PartDefinition right_leg0 = partdefinition.addOrReplaceChild("right_leg0",
				CubeListBuilder.create().texOffs(74, 104).mirror()
						.addBox(-2.5383F, -16.113F, -2.0F, 5.0F, 17.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-6.0F, 18.0F, -5.0F, 0.2657F, -0.1685F, -1.1364F));

		PartDefinition cube_r7 = right_leg0.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(84, 21).mirror()
						.addBox(-6.0F, -3.0F, 0.5F, 13.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(5.4617F, -9.113F, 0.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition cube_r8 = right_leg0.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(48, 104).mirror()
						.addBox(-6.0F, -16.0F, 0.5F, 13.0F, 17.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(0, 111).mirror()
						.addBox(-2.0F, -11.0F, -1.0F, 3.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.4617F, -16.113F, 0.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition left_leg2 = partdefinition.addOrReplaceChild("left_leg2",
				CubeListBuilder.create().texOffs(74, 104).addBox(-2.4617F, -16.113F, -3.0F, 5.0F, 17.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.0F, 18.0F, 6.0F, -0.2657F, -0.1685F, 1.1364F));

		PartDefinition cube_r9 = left_leg2.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(84, 21).addBox(-7.0F, -3.0F, -0.5F, 13.0F, 4.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.4617F, -9.113F, 0.0F, 0.0F, 0.0F, 1.5708F));
		...
		PartDefinition cube_r10 = left_leg2.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(48, 104)
						.addBox(-7.0F, -16.0F, -0.5F, 13.0F, 17.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 111)
						.addBox(-1.0F, -11.0F, -2.0F, 3.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4617F, -16.113F, 0.0F, 0.0F, 0.0F, 1.5708F));

		PartDefinition right_leg2 = partdefinition.addOrReplaceChild("right_leg2",
				CubeListBuilder.create().texOffs(74, 104).mirror()
						.addBox(-2.5383F, -16.113F, -3.0F, 5.0F, 17.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-6.0F, 18.0F, 6.0F, -0.2657F, 0.1685F, -1.1364F));

		PartDefinition cube_r11 = right_leg2.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(84, 21).mirror()
						.addBox(-6.0F, -3.0F, -0.5F, 13.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(5.4617F, -9.113F, 0.0F, 0.0F, 0.0F, -1.5708F));
		...
		PartDefinition cube_r12 = right_leg2.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(48, 104).mirror()
						.addBox(-6.0F, -16.0F, -0.5F, 13.0F, 17.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(0, 111).mirror()
						.addBox(-2.0F, -11.0F, -2.0F, 3.0F, 12.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.4617F, -16.113F, 0.0F, 0.0F, 0.0F, -1.5708F));
		...
		PartDefinition cube_r13 = right_leg1.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(84, 21).mirror()
						.addBox(-6.0F, -3.0F, 0.5F, 13.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(5.4617F, -9.113F, 0.0F, 0.0F, 0.0F, -1.5708F));
