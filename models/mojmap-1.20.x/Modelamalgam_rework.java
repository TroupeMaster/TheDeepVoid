...
public class Modelamalgam_rework<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "amalgam_rework"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-16.0F, -31.0F, -16.0F, 32.0F, 32.0F, 32.0F, new CubeDeformation(0.0F)).texOffs(0, 64)
						.addBox(-16.0F, 1.0F, -16.0F, 32.0F, 19.0F, 32.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -3.0F, 0.0F));

		PartDefinition left_leg_front = partdefinition.addOrReplaceChild("left_leg_front",
				CubeListBuilder.create().texOffs(0, 115).addBox(-6.0F, -2.0F, -6.0F, 12.0F, 25.0F, 12.0F,
		...
		PartDefinition bone = left_leg_front.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(48, 115)
						.addBox(-4.0F, -1.0F, -4.0F, 8.0F, 45.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(128, 0)
						.addBox(4.0F, -1.0F, 0.0F, 16.0F, 45.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 19.0F, 0.0F, 0.1745F, 0.0F, -1.309F));

		PartDefinition bone2 = bone.addOrReplaceChild("bone2",
				CubeListBuilder.create().texOffs(0, 152)
						.addBox(-2.0F, -1.0F, -2.0F, 4.0F, 30.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(128, 117)
						.addBox(2.0F, -1.0F, 0.0F, 18.0F, 30.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 43.0F, 0.0F, 0.0F, 0.1745F, -0.7418F));

		PartDefinition right_leg_front = partdefinition.addOrReplaceChild("right_leg_front",
				CubeListBuilder.create().texOffs(0, 115).mirror()
						.addBox(-6.0F, -2.0F, -6.0F, 12.0F, 25.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(13.0F, -27.0F, -6.0F, -0.552F, -0.3144F, -1.9151F));

		PartDefinition bone7 = right_leg_front.addOrReplaceChild("bone7",
				CubeListBuilder.create().texOffs(48, 115).mirror()
						.addBox(-4.0F, -1.0F, -4.0F, 8.0F, 45.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(128, 0).mirror()
						.addBox(-20.0F, -1.0F, 0.0F, 16.0F, 45.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 19.0F, 0.0F, 0.1745F, 0.0F, 1.309F));

		PartDefinition bone8 = bone7.addOrReplaceChild("bone8",
				CubeListBuilder.create().texOffs(0, 152).mirror()
						.addBox(-2.0F, -1.0F, -2.0F, 4.0F, 30.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(128, 117).mirror()
						.addBox(-20.0F, -1.0F, 0.0F, 18.0F, 30.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 43.0F, 0.0F, 0.0F, -0.1745F, 0.7418F));

		PartDefinition right_leg_back = partdefinition.addOrReplaceChild("right_leg_back",
				CubeListBuilder.create().texOffs(0, 115).mirror()
						.addBox(-6.0F, -2.0F, -6.0F, 12.0F, 25.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(13.0F, -27.0F, 6.0F, 0.552F, 0.3144F, -1.9151F));

		PartDefinition bone9 = right_leg_back.addOrReplaceChild("bone9",
				CubeListBuilder.create().texOffs(48, 115).mirror()
						.addBox(-4.0F, -1.0F, -4.0F, 8.0F, 45.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(128, 0).mirror()
						.addBox(-20.0F, -1.0F, 0.0F, 16.0F, 45.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
		...
		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(80, 115).addBox(-6.0F, -2.0F, -6.0F, 12.0F, 25.0F, 12.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-11.0F, -12.0F, 8.0F, -1.2841F, 0.5619F, 0.0731F));

		PartDefinition bone3 = left_arm.addOrReplaceChild("bone3",
				CubeListBuilder.create().texOffs(128, 45)
						.addBox(-4.0F, -1.0F, -4.0F, 8.0F, 34.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(128, 147)
						.addBox(4.0F, -1.0F, 0.0F, 16.0F, 34.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, 22.0F, 0.0F, -0.1309F, 0.0F, -0.2182F));

		PartDefinition bone4 = bone3.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(16, 152)
						.addBox(-2.0F, -1.0F, -2.0F, 4.0F, 23.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(128, 87)
						.addBox(-2.0F, -1.0F, 0.0F, 22.0F, 30.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 33.0F, 0.0F, -0.0436F, 0.0F, -0.2182F));

		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm",
				CubeListBuilder.create().texOffs(80, 115).mirror()
						.addBox(-6.0F, -2.0F, -6.0F, 12.0F, 25.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(11.0F, -12.0F, 8.0F, -1.2841F, -0.5619F, -0.0731F));

		PartDefinition bone11 = right_arm.addOrReplaceChild("bone11",
				CubeListBuilder.create().texOffs(128, 45).mirror()
						.addBox(-4.0F, -1.0F, -4.0F, 8.0F, 34.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(128, 147).mirror()
						.addBox(-20.0F, -1.0F, 0.0F, 16.0F, 34.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-1.0F, 22.0F, 0.0F, -0.1309F, 0.0F, 0.2182F));

		PartDefinition bone12 = bone11.addOrReplaceChild("bone12",
				CubeListBuilder.create().texOffs(16, 152).mirror()
						.addBox(-2.0F, -1.0F, -2.0F, 4.0F, 23.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(128, 87).mirror()
						.addBox(-20.0F, -1.0F, 0.0F, 22.0F, 30.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 33.0F, 0.0F, -0.0436F, 0.0F, 0.2182F));
