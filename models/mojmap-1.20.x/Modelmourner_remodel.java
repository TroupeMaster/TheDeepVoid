...
public class Modelmourner_remodel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mourner_remodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(40, 50)
				.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 24.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.0F, 0.0F, 0.0F));

		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(0, 51)
						.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 24.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 0)
						.addBox(0.0F, -1.0F, 1.0F, 0.0F, 24.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(5.0F, -8.0F, -2.0F));

		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm",
				CubeListBuilder.create().texOffs(8, 51)
						.addBox(-1.0F, -1.0F, -1.0F, 2.0F, 24.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(32, 50)
						.addBox(0.0F, -1.0F, 1.0F, 0.0F, 24.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-5.0F, -8.0F, -2.0F));

		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create()
				.texOffs(48, 50).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 24.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = head.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(18, 0)
						.addBox(-4.0F, -11.0F, 0.0F, 9.0F, 11.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(13.0F, -11.0F, 0.0F, 9.0F, 11.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-9.0F, 0.0F, 0.0F, 0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r11 = head
