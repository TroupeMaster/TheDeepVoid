...
public class Modelbaby_bone_crawler<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "baby_bone_crawler"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(
				-4.0F, -3.0F, 0.0F, 8.0F, 4.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 22.0F, -6.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 17)
						.addBox(-4.0F, -2.0F, -5.0F, 8.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 25)
						.addBox(-4.0F, -2.0F, -10.0F, 8.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition left_leg0 = partdefinition.addOrReplaceChild("left_leg0",
				CubeListBuilder.create().texOffs(0, 33)
						.addBox(0.0F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(26, 17)
						.addBox(4.0F, -2.0F, 0.0F, 10.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_leg0 = partdefinition.addOrReplaceChild("right_leg0",
				CubeListBuilder.create().texOffs(0, 37)
						.addBox(-7.0F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(26, 26)
						.addBox(-14.0F, -2.0F, 0.0F, 10.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, 21.0F, -2.0F, 0.0F, -0.3054F, -0.1745F));

		PartDefinition left_leg2 = partdefinition.addOrReplaceChild("left_leg2",
				CubeListBuilder.create().texOffs(36, 35)
						.addBox(0.0F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(26, 23)
						.addBox(4.0F, -2.0F, 0.0F, 10.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_leg2 = partdefinition.addOrReplaceChild("right_leg2",
				CubeListBuilder.create().texOffs(18, 39)
						.addBox(-7.0F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(26, 29)
						.addBox(-14.0F, -2.0F, 0.0F, 10.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, 21.0F, 4.0F, 0.0F, 0.3054F, -0.1745F));

		PartDefinition left_leg1 = partdefinition.addOrReplaceChild("left_leg1",
				CubeListBuilder.create().texOffs(18, 35)
						.addBox(0.0F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(26, 20)
						.addBox(4.0F, -2.0F, 0.0F, 10.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_leg1 = partdefinition.addOrReplaceChild("right_leg1",
				CubeListBuilder.create().texOffs(36, 39)
						.addBox(-7.0F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(26, 32)
						.addBox(-14.0F, -2.0F, 0.0F, 10.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, 21.0F, 1.0F, 0.0F, 0.0F, -0.1745F));
