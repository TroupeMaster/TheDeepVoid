...
public class Modellighthead<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "lighthead"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(132, 98)
						...
						.addBox(-11.5F, -9.0F, -25.0F, 23.0F, 23.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(98, 131)
		...
		PartDefinition cube_r6 = right_leg1.addOrReplaceChild(
				"cube_r6", CubeListBuilder.create().texOffs(106, 101).addBox(-17.8312F, -25.324F, 0.0F, 13.0F, 30.0F,
						0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(10.0F, 6.0F, 0.0F, 0.0F, 0.0F, 2.4871F));

		PartDefinition cube_r7 = right_leg1.addOrReplaceChild(
				"cube_r7", CubeListBuilder.create().texOffs(114, 145).addBox(-3.3555F, -13.8504F, -2.0F, 4.0F, 16.0F,
						4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(10.0F, 6.0F, 0.0F, 0.0F, 0.0F, 0.9163F));

		PartDefinition cube_r8 = right_leg1.addOrReplaceChild("cube_r8",
		...
		PartDefinition cube_r9 = right_leg2.addOrReplaceChild(
				"cube_r9", CubeListBuilder.create().texOffs(0, 111).addBox(-17.8312F, -25.324F, 0.0F, 13.0F, 30.0F,
						0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(10.0F, 6.0F, 0.0F, 0.0F, 0.0F, 2.4871F));

		PartDefinition cube_r10 = right_leg2.addOrReplaceChild(
				"cube_r10", CubeListBuilder.create().texOffs(130, 145).addBox(-3.3555F, -13.8504F, -2.0F, 4.0F, 16.0F,
						4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(10.0F, 6.0F, 0.0F, 0.0F, 0.0F, 0.9163F));
