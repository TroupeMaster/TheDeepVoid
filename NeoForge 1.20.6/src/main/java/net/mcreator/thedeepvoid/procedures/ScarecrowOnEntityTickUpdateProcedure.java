			...
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
					_level.playSound(null, BlockPos.containing(x + Mth.nextInt(RandomSource.create(), -15, 15), y + Mth.nextInt(RandomSource.create(), -2, 2), z + Mth.nextInt(RandomSource.create(), -15, 15)),
							BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:crow_call")), SoundSource.AMBIENT, 2, (float) Mth.nextDouble(RandomSource.create(), 1, 1.1));
				} else {
					_level.playLocalSound((x + Mth.nextInt(RandomSource.create(), -15, 15)), (y + Mth.nextInt(RandomSource.create(), -2, 2)), (z + Mth.nextInt(RandomSource.create(), -15, 15)),
							BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:crow_call")), SoundSource.AMBIENT, 2, (float) Mth.nextDouble(RandomSource.create(), 1, 1.1), false);
				}
			}
		}
	}
