			...
			if (Math.random() < 0.05) {
				...
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("block.pointed_dripstone.drip_water")), SoundSource.BLOCKS, 1, 1);
					} else {
						_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("block.pointed_dripstone.drip_water")), SoundSource.BLOCKS, 1, 1, false);
					}
				}
			}
		}
