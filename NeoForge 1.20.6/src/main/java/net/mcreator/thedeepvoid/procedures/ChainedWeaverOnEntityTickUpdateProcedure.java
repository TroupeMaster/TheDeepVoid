	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
				...
				TheDeepVoidMod.queueServerWork(170, () -> {
					...
					if (world instanceof Level _level) {
						if (!_level.isClientSide()) {
							_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:weaver_scream")), SoundSource.HOSTILE, 4, 1);
						} else {
							_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:weaver_scream")), SoundSource.HOSTILE, 4, 1, false);
						}
					}
				});
			}
		...
		if (entity.getPersistentData().getBoolean("deep_void:playingAnimation") == true) {
			if (Math.random() < 0.02) {
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("block.chain.break")), SoundSource.HOSTILE, 4, (float) 0.8);
					} else {
						_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("block.chain.break")), SoundSource.HOSTILE, 4, (float) 0.8, false);
					}
				}
			}
		}
					...
					for (Entity entityiterator : _entfound) {
						if (entityiterator instanceof Player) {
							if (Math.random() < 0.25) {
								...
								if (world instanceof Level _level) {
									if (!_level.isClientSide()) {
										_level.playSound(null, BlockPos.containing(entityiterator.getX(), entityiterator.getY() + 1.4, entityiterator.getZ()), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:weaver_ambient")),
												SoundSource.HOSTILE, (float) 0.5, 1);
									} else {
										_level.playLocalSound((entityiterator.getX()), (entityiterator.getY() + 1.4), (entityiterator.getZ()), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:weaver_ambient")),
