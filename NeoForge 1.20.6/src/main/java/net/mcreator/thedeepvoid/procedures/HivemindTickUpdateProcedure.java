...
public class HivemindTickUpdateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity.getPersistentData().getDouble("deep_void:attackChance") == 40) {
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
					_level.playSound(null, BlockPos.containing(entity.getX(), entity.getY(), entity.getZ()), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:hivemind_scream")), SoundSource.HOSTILE, 2, 1);
				} else {
					_level.playLocalSound((entity.getX()), (entity.getY()), (entity.getZ()), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:hivemind_scream")), SoundSource.HOSTILE, 2, 1, false);
				}
			}
		...
		if (entity.getPersistentData().getDouble("deep_void:attackChance") == 140) {
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
					_level.playSound(null, BlockPos.containing(entity.getX(), entity.getY(), entity.getZ()), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:hivemind_scream")), SoundSource.HOSTILE, 2, (float) 0.8);
				} else {
					_level.playLocalSound((entity.getX()), (entity.getY()), (entity.getZ()), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:hivemind_scream")), SoundSource.HOSTILE, 2, (float) 0.8, false);
				}
			}
			if (entity instanceof MisanthropicHivemindEntity) {
				((MisanthropicHivemindEntity) entity).setAnimation("animation.hivemind_scream");
			...
			for (int index0 = 0; index0 < 2; index0++) {
				...
				if (Math.random() < 0.4) {
					...
					if (world instanceof Level _level) {
						if (!_level.isClientSide()) {
							_level.playSound(null, BlockPos.containing(randomX, entity.getY(), randomZ), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:flesh")), SoundSource.HOSTILE, 2, 1);
						} else {
							_level.playLocalSound(randomX, (entity.getY()), randomZ, BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:flesh")), SoundSource.HOSTILE, 2, 1, false);
						}
					}
				} else {
					if (world instanceof ServerLevel _level)
		...
		if (entity.getPersistentData().getDouble("deep_void:attackChance") == 360) {
			if (Math.random() < 0.4) {
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(entity.getX(), entity.getY(), entity.getZ()), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:hivemind_scream")), SoundSource.HOSTILE, 2, (float) 1.2);
					} else {
						_level.playLocalSound((entity.getX()), (entity.getY()), (entity.getZ()), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:hivemind_scream")), SoundSource.HOSTILE, 2, (float) 1.2, false);
					}
				}
