...
public class StalkerFollowsPlayerProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity.getPersistentData().getBoolean("deep_void:counterAttack") == false) {
								...
								if (entity.getPersistentData().getBoolean("deep_void:enraged") == false) {
									...
									if (world instanceof Level _level) {
										if (!_level.isClientSide()) {
											_level.playSound(null, BlockPos.containing(entity.getX(), entity.getY(), entity.getZ()), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:stalker_ambient")), SoundSource.HOSTILE, 1, 1);
										} else {
											_level.playLocalSound((entity.getX()), (entity.getY()), (entity.getZ()), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:stalker_ambient")), SoundSource.HOSTILE, 1, 1, false);
										}
									}
									TheDeepVoidMod.queueServerWork(6, () -> {
										if (world instanceof Level _level) {
											if (!_level.isClientSide()) {
												_level.playSound(null, BlockPos.containing(entity.getX(), entity.getY(), entity.getZ()), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:stalker_ambient")), SoundSource.HOSTILE, 1,
														(float) 0.9);
											} else {
												_level.playLocalSound((entity.getX()), (entity.getY()), (entity.getZ()), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:stalker_ambient")), SoundSource.HOSTILE, 1, (float) 0.9,
														false);
											}
										}
									});
									TheDeepVoidMod.queueServerWork(12, () -> {
										if (world instanceof Level _level) {
											if (!_level.isClientSide()) {
												...
												_level.playLocalSound((entity.getX()), (entity.getY()), (entity.getZ()), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:stalker_ambient")), SoundSource.HOSTILE, 1, (float) 0.8,
														false);
											}
										}
									});
			...
			if (entity instanceof LivingEntity _livEnt352 && _livEnt352.hasEffect(TheDeepVoidModMobEffects.LOOKING) && entity.getPersistentData().getBoolean("deep_void:lookingRightNow") == true) {
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
					_entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 5, 99, false, false));
				if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
			...
			if (entity.getPersistentData().getBoolean("deep_void:stalkingShy") == true) {
				if (!(entity instanceof LivingEntity _livEnt357 && _livEnt357.hasEffect(TheDeepVoidModMobEffects.LOOKING)) && entity.getPersistentData().getBoolean("deep_void:lookingRightNow") == true) {
					if (entity.getPersistentData().getBoolean("deep_void:checking") == false) {
						...
						TheDeepVoidMod.queueServerWork(20, () -> {
							if (!(entity instanceof LivingEntity _livEnt361 && _livEnt361.hasEffect(TheDeepVoidModMobEffects.LOOKING))) {
								if (entity instanceof StalkingStalkerEntity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getHealth() : -1) <= 25) {
			if (entity.getPersistentData().getBoolean("deep_void:despawning") == false) {
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, BlockPos.containing(entity.getX(), entity.getY(), entity.getZ()), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:stalker_ambient")), SoundSource.HOSTILE, 1, (float) 0.8);
					} else {
						_level.playLocalSound((entity.getX()), (entity.getY()), (entity.getZ()), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:stalker_ambient")), SoundSource.HOSTILE, 1, (float) 0.8, false);
					}
				}
				entity.getPersistentData().putBoolean("deep_void:despawning", true);
				if (entity instanceof StalkingStalkerEntity) {
