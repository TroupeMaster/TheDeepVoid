...
public class DeepVoidConfigConfiguration {
	...
	public static final ModConfigSpec.ConfigValue<Boolean> PLACECULTTEMPLE;
	public static final ModConfigSpec.ConfigValue<Boolean> PLAYERSTELEPORTINVOID;
	public static final ModConfigSpec.ConfigValue<Boolean> PLAYERSTELEPORTINEND;
	public static final ModConfigSpec.ConfigValue<Double> TELEPORTHEIGHT;
	public static final ModConfigSpec.ConfigValue<Boolean> DEEPVOIDFOG;
	public static final ModConfigSpec.ConfigValue<Boolean> STOPACTIVEBLOCKGENERATION;
	public static final ModConfigSpec.ConfigValue<Boolean> OLDHOLESTRUCTURE;
	public static final ModConfigSpec.ConfigValue<Boolean> SPAWNABDUCTORS;
	public static final ModConfigSpec.ConfigValue<Boolean> SPAWNFALLINGCORPSE;
	public static final ModConfigSpec.ConfigValue<Boolean> PLACECORPSEONIMPACT;
	public static final ModConfigSpec.ConfigValue<Boolean> STALKERSPAWNS;
	public static final ModConfigSpec.ConfigValue<Boolean> STALKINGSTALKERSPAWNS;
	public static final ModConfigSpec.ConfigValue<Double> STALKERSPAWNTIMER;
	public static final ModConfigSpec.ConfigValue<Boolean> SEEKLIGHTWARNING;
	public static final ModConfigSpec.ConfigValue<Boolean> DESTROYLIGHTSOURCES;
	public static final ModConfigSpec.ConfigValue<Double> VOIDBLESSINGTIMER;
	public static final ModConfigSpec.ConfigValue<Boolean> ALLOWOTHERWORLDTP;
	public static final ModConfigSpec.ConfigValue<Boolean> ALLOWSOULLIGHT;
	public static final ModConfigSpec.ConfigValue<Boolean> PLAYERHALLUCINATES;
	public static final ModConfigSpec.ConfigValue<Boolean> STALKERBREAKSBLOCKS;
	public static final ModConfigSpec.ConfigValue<Boolean> DARKNESS;
	public static final ModConfigSpec.ConfigValue<Boolean> HELL;
	public static final ModConfigSpec.ConfigValue<Boolean> STALKED;
	public static final ModConfigSpec.ConfigValue<Boolean> CORPSERAIN;
	public static final ModConfigSpec.ConfigValue<Boolean> CREEPINGDARKNESS;
	public static final ModConfigSpec.ConfigValue<Boolean> ENDLESSABYSS;
	public static final ModConfigSpec.ConfigValue<Boolean> PURGATORY;
	public static final ModConfigSpec.ConfigValue<Boolean> GIVETORCHES;
	public static final ModConfigSpec.ConfigValue<Boolean> OVERWRITEWITHSEPULCHER;
	public static final ModConfigSpec.ConfigValue<Boolean> OVERWRITEWITHTEMPLE;
	static {
