...
public class LavenditeVoidriumSwordItem extends SwordItem {
	...
	public LavenditeVoidriumSwordItem() {
		super(TOOL_TIER, new Item.Properties().attributes(SwordItem.createAttributes(TOOL_TIER, 6f, -1.9f)).fireResistant());
	}
