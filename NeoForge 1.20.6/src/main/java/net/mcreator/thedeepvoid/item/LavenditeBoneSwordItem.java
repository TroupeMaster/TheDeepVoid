...
public class LavenditeBoneSwordItem extends SwordItem {
	...
	public LavenditeBoneSwordItem() {
		super(TOOL_TIER, new Item.Properties().attributes(SwordItem.createAttributes(TOOL_TIER, 3f, -1.9f)));
	}
