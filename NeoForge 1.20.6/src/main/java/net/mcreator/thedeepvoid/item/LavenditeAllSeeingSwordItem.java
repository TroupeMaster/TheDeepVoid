...
public class LavenditeAllSeeingSwordItem extends SwordItem {
	...
	public LavenditeAllSeeingSwordItem() {
		super(TOOL_TIER, new Item.Properties().attributes(SwordItem.createAttributes(TOOL_TIER, 5f, -1.9f)).fireResistant());
	}
