...
public class WeaverOfSoulsEntity extends Monster implements GeoEntity {
	...
	public WeaverOfSoulsEntity(EntityType<WeaverOfSoulsEntity> type, Level world) {
		super(type, world);
		xpReward = 250;
		setNoAi(false);
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "fallenweaver");
	}
	...
	public SoundEvent getDeathSound() {
		return BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:weaver_scream"));
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 73) {
			this.remove(WeaverOfSoulsEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
