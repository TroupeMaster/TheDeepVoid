...
import net.mcreator.thedeepvoid.procedures.ChainedWeaverRightClickedOnEntityProcedure;
import net.mcreator.thedeepvoid.procedures.ChainedWeaverOnEntityTickUpdateProcedure;

public class ChainedWeaverEntity extends Monster implements GeoEntity {
	...
	public ChainedWeaverEntity(EntityType<ChainedWeaverEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "chainedweaver");
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new LookAtPlayerGoal(this, Player.class, (float) 80));
	}
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:weaver_ambient"));
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("the_deep_void:weaver_hurt"));
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		ChainedWeaverRightClickedOnEntityProcedure.execute(world, entity, sourceentity);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		ChainedWeaverOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	private PlayState movementPredicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			return event.setAndContinue(RawAnimation.begin().thenLoop("animation.chainedWeaver_idle"));
		}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ChainedWeaverEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
