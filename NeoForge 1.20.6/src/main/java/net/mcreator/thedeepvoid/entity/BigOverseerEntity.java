...
public class BigOverseerEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(BigOverseerEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(BigOverseerEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BigOverseerEntity.class, EntityDataSerializers.STRING);
	...
	public BigOverseerEntity(EntityType<BigOverseerEntity> type, Level world) {
		super(type, world);
		xpReward = 8;
		setNoAi(false);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BigOverseerEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
