...
public class Modelmother_bone_crawler<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("the_deep_void", "modelmother_bone_crawler"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-9.0F, -6.0F, -1.0F, 18.0F, 8.0F, 31.0F, new CubeDeformation(0.0F)).texOffs(90, 77).addBox(-8.0F, 2.0F, 0.0F, 16.0F, 3.0F, 29.0F, new CubeDeformation(0.0F)).texOffs(0, 77)
						...
						.addBox(0.0F, -6.1F, 4.0F, 11.0F, 0.0F, 38.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(90, 109).addBox(-6.0F, -18.0F, 12.0F, 8.0F, 12.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(42, 112)
						.addBox(-1.0F, -15.0F, 16.0F, 7.0F, 9.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(0, 117).addBox(-2.0F, -13.0F, 9.0F, 6.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(122, 109)
						.addBox(2.0F, -12.0F, 12.0F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)),
